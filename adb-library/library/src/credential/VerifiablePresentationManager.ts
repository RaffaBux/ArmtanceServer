...
> {
    ...
    public async createVerifiablePresentation(
        ...
        // Generate the proof
        const proof = await this.proofManager.createPresentationProof(presentation, proofCreationOptions);
    ...
    public async verifyPresentation(
        ...
        // Verify the proof
        if (
            !(await this.proofManager.verifyPresentationProof(verifiablePresentation, proofVerificationOptions))
        ) {
            throw new InvalidVerifiablePresentationError(
